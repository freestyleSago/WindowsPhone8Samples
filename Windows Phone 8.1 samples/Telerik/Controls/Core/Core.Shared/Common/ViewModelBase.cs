...
namespace Telerik.Core
{
    ...
    public abstract class ViewModelBase : INotifyPropertyChanged
    {
        ...
        {
            // The OnPropertyChanged is not virtual itself because of the [CallerMemberName] attribute which in case overriden should be put in every override - quite error-prone.
