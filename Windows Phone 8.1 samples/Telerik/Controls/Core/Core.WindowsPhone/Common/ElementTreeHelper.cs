...
namespace Telerik.Core
{
    ...
    public static class ElementTreeHelper
    {
        ...
        /// <summary>
        /// Transforms a rectangle according to the provided float direction. Since a <see cref="Rect"/>
        /// struct has its origin always at the top left point, to make a <see cref="Rect"/> usable
