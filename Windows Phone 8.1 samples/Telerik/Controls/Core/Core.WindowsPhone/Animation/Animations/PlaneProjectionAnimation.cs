...
namespace Telerik.Core
{
    ...
    public class RadPlaneProjectionAnimation : RadAnimation
    {
        ...
        /// </summary>
        public PerspectiveAnimationAxis Axes
        {
            get;
            set;
        }
        ...
        /// </summary>
        public PerspectiveAnimationDirection Direction
        {
            get;
            set;
        }
