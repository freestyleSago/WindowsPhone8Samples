...
namespace Telerik.Core
{
    ...
    public class PlayAnimationInfo
    {
        ...
        public object[] GetAnimatedValues(RadAnimation animation)
        {
            object[] values;
            this.animatedValues.TryGetValue(animation, out values);
        ...
        public void SetAnimatedValues(RadAnimation animation, object[] values)
        {
            this.animatedValues[animation] = values;
        }
    }
}
