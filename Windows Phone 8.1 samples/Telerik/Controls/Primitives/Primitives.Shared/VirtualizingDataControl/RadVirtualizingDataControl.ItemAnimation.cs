...
namespace Telerik.UI.Xaml.Controls.Primitives
{
    public partial class RadVirtualizingDataControl
    {
        ...
        public static readonly DependencyProperty ItemAddedAnimationIntervalProperty =
            DependencyProperty.Register("ItemAddedAnimationInterval", typeof(TimeSpan), typeof(RadVirtualizingDataControl), new PropertyMetadata(TimeSpan.FromSeconds(0.1), OnItemAddedAnimationIntervalChanged));
        ...
        public static readonly DependencyProperty ItemRemovedAnimationIntervalProperty =
            DependencyProperty.Register("ItemRemovedAnimationInterval", typeof(TimeSpan), typeof(RadVirtualizingDataControl), new PropertyMetadata(TimeSpan.FromSeconds(0.1), OnItemRemovedAnimationIntervalChanged));
        ...
        /// are played. This property also defines whether items will be animating when the <see cref="Telerik.UI.Xaml.Controls.Primitives.DataControlBase.ItemsSource"/>
