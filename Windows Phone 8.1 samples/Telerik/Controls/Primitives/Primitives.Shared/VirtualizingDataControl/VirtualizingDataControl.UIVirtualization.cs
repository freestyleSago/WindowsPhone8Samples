...
namespace Telerik.UI.Xaml.Controls.Primitives
{
    ...
    public partial class RadVirtualizingDataControl
    {
        ...
        private bool enableAsyncBalance = true;
        ...
        /// <see cref="Telerik.UI.Xaml.Controls.Primitives.AsyncBalanceMode.Standard"/> mode implies that each visual container is realized
        /// asynchronously, whereas the <see cref="Telerik.UI.Xaml.Controls.Primitives.AsyncBalanceMode.FillViewportFirst"/> implies
        ...
        internal void ManageViewport()
        {
            ...
            {
                //// Manages the visual items from the top edge of the viewport
                //// until the end of the viewport plus the bottom visual buffer.
                this.virtualizationStrategy.ManageLowerViewport(true);
            }

            if (this.CanBalance(BalanceOperationType.ManageUpperViewport))
            {
                ////Manages the visual space above the viewport's top edge. Checks whether an item inside this buffer
                ////should be recycled or realized.
        ...
        async internal void BalanceVisualSpace()
        {
            if (!this.IsOperational())
            {
                return;
        ...
        internal IDataSourceItem GetInitialVirtualizationItem()
        {
            ...
            {
                ////The initial virtualization item can be accessed only once after set. Upon initial access
                ////the store for it is cleared.
