...
namespace Telerik.UI.Xaml.Controls.Primitives
{
    ...
    public partial class RadVirtualizingDataControl : DataControlBase, IItemsContainer, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty VirtualizationStrategyDefinitionProperty =
            DependencyProperty.Register("VirtualizationStrategyDefinition",
                typeof(VirtualizationStrategyDefinition),
                typeof(RadVirtualizingDataControl),
                new PropertyMetadata(new StackVirtualizationStrategyDefinition() { Orientation = Orientation.Vertical },
                    OnVirtualizationStrategyDefinitionChanged));
        ...
        /// <summary>
        /// Determines whether asynchronous balance may be used when needed - for example when the control is initially loading its items or upon a <see cref="BringIntoView"/> call.
        /// </summary>
        ...
        /// <summary>
        /// Gets the top vieport item currently realized in <see cref="RadDataBoundListBox"/>.
        /// </summary>
        ...
        public virtual void BringIntoView(object item, Action scrollCompletedAction)
        {
            ...
            var bringIntoViewOperation = new BringIntoViewOperation(item) { CompletedAction = scrollCompletedAction };
        ...
        internal void ApplyScrollOffsetForItem(IDataSourceItem item)
        {
            double offset = ((this.virtualizationStrategy.ScrollableContentLength - this.virtualizationStrategy.ViewportLength) / this.GetItemCount()) * item.Index;
        ...
        /// <summary>
        /// Occurs when the <see cref="Telerik.UI.Xaml.Controls.Primitives.TemplateProviderControl.ItemTemplate" /> property has changed.
        /// </summary>
        ...
        /// <summary>
        /// Occurs when the <see cref="Telerik.UI.Xaml.Controls.Primitives.TemplateProviderControl.ItemContainerStyle" /> property has changed.
        /// </summary>
        ...
        /// <summary>
        /// Occurs when the <see cref="Telerik.UI.Xaml.Controls.Primitives.TemplateProviderControl.ItemContainerStyleSelector" /> property has changed.
        /// </summary>
        /// <param name="oldSelector"></param>
