using Telerik.Universal.UI.Xaml.Controls.Primitives.Pagination;
using Windows.Foundation.Collections;
using Windows.UI.Xaml;
using Windows.UI.Xaml.Controls;
using Windows.UI.Xaml.Controls.Primitives;

namespace Telerik.Universal.UI.Xaml.Controls.Primitives
{
    /// <summary>
    ...
    public class RadPaginationControl : RadControl
    {
        ...
        private void UpdateIndexControl()
        {
            ...
            {
                this.indexLabelControl.SetValues(0, -1);
            }
        }
