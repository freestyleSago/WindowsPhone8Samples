...
namespace Telerik.UI.Xaml.Controls.Primitives
{
    public partial class RadDataBoundListBox
    {
        ...
        bool isItemsPanelTranslated = false;
        internal bool animating;
        internal bool isPullToRefreshTriggered;

        private Storyboard translateStorybord;
        private DoubleAnimation translateAnimation;

        /// <summary>
        /// Gets or sets a boolean value determining whether the Pull to Refresh indicator is
        ...
        internal void TranslateItemsPanel(double offset)
        {
            ...
            this.animating = true;
            //  this.desiredItemsPanelOffset = offset;
        }
        ...
        protected virtual void OnReleseRequested()
        {
            this.pullToRefreshIndicator.StartRelase();
        }
