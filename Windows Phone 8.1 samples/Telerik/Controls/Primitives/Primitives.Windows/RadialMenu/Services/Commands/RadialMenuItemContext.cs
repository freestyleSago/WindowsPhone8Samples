...
namespace Telerik.UI.Xaml.Controls.Primitives.Menu
{
    ...
    {
        /// <summary>
        /// Gets or sets the menu item that has triggered the command.
        /// </summary>
        /// <value>The menu item.</value>
        public RadialMenuItem MenuItem { get; internal set; }

        /// <summary>
        /// Gets or sets the target element that <see cref="RadRadialMenu"/> is associated with when used as a context menu.
        /// </summary>
