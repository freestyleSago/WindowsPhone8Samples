...
namespace Telerik.UI.Xaml.Controls.Primitives
{
    ...
    public partial class RadRadialMenu : RadControl
    {
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether a tool tip, displaying the current selected <see cref="RadialMenuItem"/> header text, will be displayed.
        /// </summary>
        /// <example>
        /// <code language="xaml">
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether the <see cref="RadRadialMenu"/> is open.
        /// </summary>
        /// <example>
        /// <code language="xaml">
